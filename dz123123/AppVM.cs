...
namespace PhoneListMVVM
{
    public class AppVM : INotifyPropertyChanged
    {
        ...
        public AppVM()
        {
            ...
            {
                new Phone { Title="ShitPhone 14", Company = "Shit", Price = 69000 },
                new Phone { Title="Sasung Ass 22", Company = "Sasung", Price = 13370 },
                new Phone { Title="XIaomi 12", Company = "XIaomi", Price = 99999 },
                new Phone { Title="ReadME", Company = "GitHub", Price = 232323 }
            };
